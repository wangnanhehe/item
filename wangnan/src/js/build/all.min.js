...
function config(t,e){e.otherwise("login"),t.state("index",{url:"/index",templateUrl:"view/index.html"}).state("destination",{url:"/destination",templateUrl:"view/destination.html"}).state("find",{url:"/find",templateUrl:"view/find.html"}).state("user",{url:"/user",templateUrl:"view/user.html"}).state("foot",{url:"/foot",templateUrl:"view/foot.html"}).state("food_det",{url:"/food_det",templateUrl:"view/food_det.html"}).state("china",{url:"/china",templateUrl:"view/china.html"}).state("zhoubian",{url:"/zhoubian",templateUrl:"view/zhoubian.html"}).state("rim",{url:"/rim",templateUrl:"view/rim.html"}).state("arrange",{url:"/arrange",templateUrl:"view/arrange.html"}).state("baike",{url:"/baike",templateUrl:"view/baike.html"}).state("hot",{url:"/hot",templateUrl:"view/hot.html"}).state("login",{url:"/login",templateUrl:"view/login.html",controller:"logina"}).state("forget",{url:"/forget",templateUrl:"view/forget.html"}).state("money",{url:"/money",templateUrl:"view/money.html"}).state("often",{url:"/often",templateUrl:"view/often.html"}).state("tuijian",{url:"/tuijian",templateUrl:"view/tuijian.html"}).state("des_detail",{url:"/des_detail",templateUrl:"view/des_detail.html"})}config.$inject=["$stateProvider","$urlRouterProvider"],angular.module("myapp").config(config);
function HelloAngular(n){}function login(n,o,a){n.one=function(){var e=n.username,i=n.password;a.login("http://localhost:8080/login",{username:e,password:i},"jsonp").success(function(n){alert(n.msg),1==n.code&&(console.log(n.nicheng),localStorage.name=n.nicheng,sessionStorage.image=n.img,o.url("/user"))})}}function rim(n,o,a){a.login("http://localhost:8080/rim",{name:"dfas",age:20},"jsonp").success(function(o){for(var a=0;a<o.length;a++){for(var a in o[0])n.data=o[0][a];n.add1=function(){for(var a in o[0])n.data1="",n.data2="",n.data3="",n.data=o[0][a]},n.add2=function(){for(var a in o[1])n.data="",n.data2="",n.data3="",n.data1=o[1][a]},n.add3=function(){for(var a in o[2])n.data="",n.data1="",n.data3="",n.data2=o[2][a]},n.add4=function(){for(var a in o[3])n.data="",n.data1="",n.data2="",n.data3=o[3][a]}}})}function user(n){sessionStorage.image&&(n.img=sessionStorage.image)}function con(n){n.$on("ngRepeatFinished",function(n){alert(9)})}function logina(n,o,a){n.submit=function(){console.log(a),a.login("http://localhost:3001/login",{username:n.username,userpwd:n.userpwd},"jsonp").success(function(n){0==n.code&&o.url("/index")})}}HelloAngular.$inject=["$scope"],login.$inject=["$scope","$location","apiService"],rim.$inject=["$scope","$location","apiService"],user.$inject=["$scope"],con.$inject=["$scope"],logina.$inject=["$scope","$location","apiService"],angular.module("myapp").controller("HelloAngular",HelloAngular).controller("login",login).controller("rim",rim).controller("user",user).controller("con",con).controller("logina",logina);
function pageTitle(i){return{restrict:"A",link:function(e,n){i.$on("$stateChangeStart",function(i,e){var t="当前页面--";e.data&&e.data.title&&(t+=e.data.title),n.text(t)})}}}function pageTab(){return{restrict:"A",link:function(i,e){$("#nav").on("click","span",function(){$(this).addClass("bg").siblings().removeClass("bg");var i=$(this).index();$("#d_box>div").eq(i).show().siblings().hide()}),$("#x_nav").on("click","span",function(){var i=$(this).index();$(this).addClass("no").siblings().removeClass("no"),$("#x_box").find("ul").eq(i).show().siblings().hide()})}}}function yinDao(){return{restrict:"A",link:function(i,e){new Swiper(".swiper-container",{pagination:".swiper-pagination",paginationClickable:!0,autoplay:5e3,onTouchEnd:function(i){for(var e=i.activeIndex,n=document.getElementsByTagName("h2"),t=0;t<n.length;t++)n[t].style.display="none";n[e].style.display="block"}})}}}function pageSwiper(){return{restrict:"A",link:function(i,e){new Swiper(".swiper-container",{pagination:".swiper-pagination",paginationClickable:!0,autoplay:2e3,loop:!0,autoplayDisableOnInteraction:!1})}}}function pageIscroll(i){return{restrict:"A",link:function(i,e){setTimeout(function(){new IScroll("#home",{click:!0})},200)}}}function desPage(){return{restrict:"A",link:function(i,e){$(".list").on("click","li",function(i){i.preventDefault();var e=$(this).index();$(".right section").eq(e).css("left","0").siblings().css("left","200%"),$(this).addClass("on").siblings().removeClass("on")})}}}function foodDet(){return{restrict:"A",link:function(i,e){$(".lis").on("click","li",function(){var i=$(this).index();$(".box").find("section").eq(i).css("left","0").siblings().css("left","100%"),$(this).addClass("bg").siblings().removeClass("bg")})}}}function chinaPage(){return{restrict:"A",link:function(i,e){var n=["西安","天津","上海","哈尔滨"];$(".city").on("click","li",function(){if($(this).hasClass("more"))if("更多"==$(this).text()){var i="";$.each(n,function(e,n){i+="<li class='ap'>"+n+"</li>"}),$(this).before(i),$(this).text("收起")}else $(".ap").remove(),$(this).text("更多");else $(this).addClass("on").siblings().removeClass("on")})}}}function rimPage(){return{restrict:"A",link:function(i,e){$(".rim_nav").on("click","li",function(){var i=$(this).index();$(".rim_section").eq(i).css("left","0").siblings().css("left","100%"),$(this).addClass("rim_on").siblings().removeClass("rim_on")})}}}function gongPage(){return{restrict:"A",link:function(i,e){$(".arrange_nav").css({position:"relative",top:"0"}),$(".arrange_nav").on("click","li",function(){var i=$(this).index();$(".rim_section").eq(i).css("left","0").siblings().css("left","100%"),$(this).addClass("arrange_on").siblings().removeClass("arrange_on")})}}}function swiperPage(){return{restrict:"A",link:function(i,e){new Swiper(".swiper-container",{pagination:".swiper-pagination",paginationClickable:!0,autoplay:1e3,autoplayDisableOnInteraction:!1})}}}function baikePage(){return{restrict:"A",link:function(i,e){var n=new Date,t=n.getDay();switch(t){case 1:t="星期一";break;case 2:t="星期二";break;case 3:t="星期三";break;case 4:t="星期四";break;case 5:t="星期五";break;case 6:t="星期六";break;case 7:t="星期日"}$(".baike_tit").text(n.toLocaleDateString()+" "+t)}}}pageTitle.$inject=["$rootScope"],pageIscroll.$inject=["$timeout"],angular.module("myapp").directive("pageTitle",pageTitle).directive("pageTab",pageTab).directive("yinDao",yinDao).directive("pageSwiper",pageSwiper).directive("pageIscroll",pageIscroll).directive("desPage",desPage).directive("foodDet",foodDet).directive("chinaPage",chinaPage).directive("rimPage",rimPage).directive("gongPage",gongPage).directive("swiperPage",swiperPage).directive("baikePage",baikePage);
function apiService(r){function e(r){var e=[];for(i in r)e.push(i+"="+r[i]);return"?"+e.join("&")}function n(i,n,t){var n=n||{},t=t.toUpperCase();if("POST"==t)return r.post(i,n);if("JSONP"==t){var a=e(n);return r.jsonp(i+a+"&callback='JSON_CALLBACK'")}var c=e(n);return r.get(i+c)}this.login=function(i,r,e){return n(i,r,e)}}apiService.$inject=["$http"],angular.module("myapp").service("apiService",apiService);